...
namespace PrjStoredProcedure.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<NameTblCar> NameTblCars { get; set; }
...
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<NameTblCar>(entity =>
            {
                entity.HasKey(e => e.Carno)
                    .HasName("PK_dbo.name=tblCar");

                entity.ToTable("name=tblCar");
            ...
            modelBuilder.Entity<Student>(entity =>
            {
                entity.HasKey(e => e.Sid)
                    .HasName("PK__Student__DDDFDD365B6F1D00");
